function requestPlayerID() {
  ...
  function saveHistory(gameId, playerId, displayName, payout) {
    var xmlhttp = new XMLHttpRequest();
    return new Promise ((resolve, reject) => {      
      let url = "../php/writehistory.php";

      var loc = window.location.pathname;
      var dir = loc.substring(loc.lastIndexOf('/'));
      if (dir == "/inventory.php") {
        url = "../../php/writehistory.php";
      }
  ...
  function finishGame(gameId) {
    ...
    return new Promise ((resolve, reject) => {      
      ...
      let data = {'gameID': gameId, "finish": true};
      xmlhttp.send(JSON.stringify(data));
    });
  }
  ...
  function requestAllCompletedGames(playerID) {
    var xmlhttp = new XMLHttpRequest();
    return new Promise ((resolve, reject) => {
      ...
      let url = "../php/allcompletedgames.php?playerID=";

      var loc = window.location.pathname;
      var dir = loc.substring(loc.lastIndexOf('/'));
      if (dir == "/inventory.php") {
        url = "../../php/allcompletedgames.php?chainID=";
      }
  ...
  export { requestPlayerID, requestDisplayName, requestChains, 
    ...
    realTimeUpdate, finishGame, updateCareer, requestAllCompletedGames};