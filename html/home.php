...
<body>
  ...
  <div class="top-banner container">
    <div class="row">
      ...
      <div class="col-md-4">
        <iframe width="500" height="255" src="https://www.youtube.com/embed/QCdJ1_WY1dA" title="YouTube video player"
          frameborder="0"
  ...
  <div class="top-banner container">
    <div class="row">
      <div class="col-md-6">
        ...
        <p>Notice how the second word &ldquo;Open&rdquo; can be associated with the top word &ldquo;Crack&rdquo; and the
          bottom word &ldquo;Sesame&rdquo;. For each game you are automatically given the 1st and 7th word, and you have
          to guess to complete the chain!</p>
      </div>
      ...
      <div class="col-md-6">
        ...
        <ul>
          <li aria-level="1">Teams take turns attempting to guess the empty words in the chain. During every turn, only
            ...
            turns rotate from player to player, forming a cycle.&nbsp;</li>
          <li aria-level="1">For every turn, a team player can decide to either guess the &ldquo;above&rdquo; word or
            the &ldquo;below&rdquo; word. Above meaning above the bottommost completed word, and vice versa for
            below.&nbsp;</li>
          <li aria-level="1">After choosing above or below, the team player may either ask for a letter, or not at all.
            Once given or not given a letter, a team player may guess the word at hand.
            <ul>
              <li aria-level="3">Note: If asking for a letter will complete said word, the guessing team&rsquo;s turn
                will immediately end, and no points will be awarded to either team.This cycle will continue until all
                words have been completed</li>
            </ul>
          </li>
          <ul>
            <li aria-level="2">If the guessed word is wrong, then the turn will restart, with the other team now having
              a turn.</li>
            <li aria-level="2">If the guessed word is correct, the word is completed, the guessing team will gain
              points, and have another turn.</li>
          </ul>
        </ul>
      </div>
    </div>
  ...
  <div class="top-banner container">
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <ul>
          <li aria-level="1"> <a href="login.php"> After Logging in </a>, go to Play and insert the room code that your
            friends are playing with. </li>
        </ul>
      </div>
    </div>
  </div>
          ...
          <div class="col-md-6">
            ...
            <ul>
              ...
              <ul>
                ...
                <li aria-level="2">The maximum number of points = sum of characters per word for all 5 words * 10,000
                </li>
                <li aria-level="2">Each second of thinking reduces the points by a flat amount</li>
                <ul>
                  <li aria-level="3">If they are 100 seconds to play then, each second will reduce your score by 1% of
                    the
                    maximum
                    points</li>
                  <li aria-level="3">If they are 50 seconds to play, then each second will reduce your score by 2% of
                    the
                    maximum
                    points</li>
                </ul>
